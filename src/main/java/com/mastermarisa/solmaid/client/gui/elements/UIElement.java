package com.mastermarisa.solmaid.client.gui.elements;
...
public abstract class UIElement {
    ...
    public java.util.List<Component> tooltip = new ArrayList<>();
    ...
    public static boolean onMouseClicked(UIElement element, double mouseX, double mouseY, int button) {
        return onMouseClicked(java.util.List.of(element),mouseX,mouseY,button);
    }

    public static boolean onMouseClicked(java.util.List<? extends UIElement> elements, double mouseX, double mouseY, int button) {
    ...
    public static boolean onMouseScrolled(UIElement element, double mouseX, double mouseY, double scrollX, double scrollY) {
        return onMouseScrolled(java.util.List.of(element),mouseX,mouseY,scrollX,scrollY);
    }

    public static boolean onMouseScrolled(java.util.List<? extends UIElement> elements, double mouseX, double mouseY, double scrollX, double scrollY) {
