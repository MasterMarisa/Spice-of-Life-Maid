...
public class ModConfig {
    ...
    public static final ModConfigSpec.ConfigValue<List<? extends Integer>> MILESTONES = BUILDER
            ...
            .defineList("milestones", Lists.newArrayList(new Integer[]{10, 20, 30, 40, 50}), () -> 0, (e) -> e instanceof Integer);
    ...
    public static final ModConfigSpec.IntValue FAVORABILITY_PER_MILESTONE = BUILDER
            ...
            .defineInRange("favorabilityPerMilestone", 10, 0, 1000);
    ...
    public static int getFavorabilityPerMilestone() { return FAVORABILITY_PER_MILESTONE.getAsInt(); }
